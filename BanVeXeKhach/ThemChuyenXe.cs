...
namespace BanVeXeKhach
{
    public partial class ThemChuyenXe : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                str = "insert chuyenxe values ('CX0" + (cx.count_Chuyenxe() + 1) + "',N'" + t.Diem1 + "',N'" + t.Diem2 + "','" + dateTimePicker1.Text + "', '" + dateTimePicker2.Text + "', '" + comboBox.SelectedValue + "' , 'X01','" + comboBox3.SelectedValue + "',0, " + giave.Text + ",1)";
            }
            else if(luotve_rdo.Checked == true)
            {
                str = "insert chuyenxe values ('CX0" + (cx.count_Chuyenxe() + 1) + "',N'" + t.Diem2 + "',N'" + t.Diem1 + "','" + dateTimePicker1.Text + "', '" + dateTimePicker2.Text + "', '" + comboBox.SelectedValue + "' , 'X01','" + comboBox3.SelectedValue + "',0, " + giave.Text + ",1)";
            }
            else
            {
